...
export class DiveSiteData{
    ...
    geoData: GeoData;
    extraInfo: ExtraInfo;
    constructor (id: number, name: string, description: string, location: string, country: string, geoData: GeoData, extraInfo: ExtraInfo){
        this.id = id;
        this.name = name;
