...
import { FlorafaunaViewModel } from "./florafauna-view-model";


const vm = new FlorafaunaViewModel();
/* ***********************************************************
...
export function onNavigatingTo(args: NavigatedData) {
    ...
    *************************************************************/
    ...
    vm.set("titel", "F" + pageName.substring(1));
...
export function openListItem(args: EventData){
    var navigationEntry = {
        moduleName: "florafauna/florafauna-details-page",
        context: {
